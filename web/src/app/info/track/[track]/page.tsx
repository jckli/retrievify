			...
			<div className="navbar:ml-[280px] flex font-metropolis text-white">
				<div className="m-8 flex flex-col 1.5xl:flex-row w-[100%] overflow-auto">
					...
					<div className="1.5xl:w-[70%] flex flex-col 1.5xl:ml-8">
						<div
							id="audio-features"
							className="mt-8 1.5xl:mt-0 flex gap-4 flex-wrap justify-center"
						>
							<div
								id="acoustic"
								className="bg-mgray rounded-md w-full sxsm:w-auto"
							>
								<div className="p-5">
							...
							>
								<div className="p-5">
									...
									<div className="mt-2 w-full sxsm:w-[175px]">
										<ProgressBar
											progress={afData.energy * 100}
										/>
										<p className="mt-1 text-sm">
											{(afData.energy * 100).toFixed(
												1,
											)}
											/100
										</p>
							...
							>
								<div className="p-5">
									...
									<div className="mt-2 w-full sxsm:w-[175px]">
										<ProgressBar
											progress={afData.valence * 100}
										/>
										<p className="mt-1 text-sm">
											{(afData.valence * 100).toFixed(
												1,
											)}
											/100
										</p>
						...
						<div id="audio-analysis" className="mt-8 bg-mgray rounded-md">
							<div className="p-5">
								...
								<div className="mt-4 flex gap-4 flex-wrap justify-center">
									<div
										id="key"
										className="bg-[#303030] rounded-md"
									>
										<div className="p-5">
