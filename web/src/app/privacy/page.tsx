		...
		<>
			<div className="mt-14 md:m-14 px-12 text-white font-metropolis max-w-[1000px]">
				...
				<p className="mt-3">
					...
					Retrievify team at no cost and is intended for use as is. This page is used to
				...
				<h2 className="font-proximaNova font-bold text-2xl mt-4">
					Information Collection and Use
				</h2>
				<p className="mt-3">
					We do not store any information or data used by Retrievify nor shared with third
					parties. However, for a better experience, the data package feature is stored on
					your device&apos;s browser storage, in a section called &quot;Local
					Storage&quot;. This data is not stored on our servers, and can be deleted at any
					time by clearing your browser cookies and data for the site. All information is
					used solely for displaying statistics and information on the website. By
					choosing to use this app, you agree to the use of your Spotify account data for
					the purposes of this app.
				</p>
				<h2 className="font-proximaNova font-bold text-2xl mt-4">Deletion of Data</h2>
				<p className="mt-3">
					Although your data is not being stored server-sided or used maliciously, if you
					would like to revoke Retrievify&apos;s permissions,{" "}
					<a
					...
					is a guide for doing so. To delete your data package data from your browser,
					simply clear your browser&apos;s cookies and data for the site.
				</p>
				...
				<p className="mt-3">
					...
					<a
						className="inline-block underline underline-offset-2"
						href="mailto:support@hayasaka.moe"
					>
