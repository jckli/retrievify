...
print("7. Total Time Listened to Song in a Year (Not working)")
print("8. Total Time Listened to Artist (Not Working)")
print("9. Total Time Listened to Artist in a Year (Not Working)")
