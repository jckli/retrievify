...
async def get_track_audio_features(request, id):
    ...
    if access_token is None:
        return await get_track_audio_features_refresh(
            spotify, body.get("refresh_token"), id
        )
    user_resp = await spotify.get_track_audio_features(access_token, id)
